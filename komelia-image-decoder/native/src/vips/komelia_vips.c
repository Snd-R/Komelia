...
JNIEXPORT void JNICALL
Java_io_github_snd_1r_VipsImage_gObjectUnref(JNIEnv *env, jobject this, jlong ptr) {
    g_object_unref((VipsImage *) ptr);
}

JNIEXPORT void JNICALL
Java_io_github_snd_1r_VipsImage_free(JNIEnv *env, jobject this, jlong bytes) {
    free((void *) bytes);
}
