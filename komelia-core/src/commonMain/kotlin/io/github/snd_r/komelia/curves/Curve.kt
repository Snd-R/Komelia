...
import io.github.snd_r.komelia.curves.Curve.CurvePointType.CORNER
import io.github.snd_r.komelia.curves.Curve.CurvePointType.SMOOTH
...
class Curve {
    ...
    val lookupTable = curveState.map { LookupTable(calculateLookupTable(it.samples)) }
