...
public abstract class AbstractFlywayTask extends DefaultTask {
     ...
     * See <a href="https://documentation.red-gate.com/flyway/flyway-cli-and-api/configuration/parameters/flyway/ignore-migration-patterns">...</a> for full details
    ...
    public Object runTask() {
        ...
        try {
            ...
            Flyway flyway = Flyway.configure(pluginClassLoader).configuration(config).load();
