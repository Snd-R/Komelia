...
object AppDirectories {
    private val projectDirs = ProjectDirectories.from("io.github.snd-r.komelia", "", "Komelia")
    val onnxRuntimeInstallPath: Path = Path(projectDirs.dataDir).resolve("onnxruntime")
    val mangaJaNaiInstallPath: Path = Path(projectDirs.dataDir).resolve("mangajanai")
