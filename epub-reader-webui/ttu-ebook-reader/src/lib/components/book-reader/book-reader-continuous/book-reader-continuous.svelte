<script lang="ts">
  ...
  export let fontFamilyGroupOne: Font;

  export let fontFamilyGroupTwo: Font;
  ...
  export let bookmarkData: Promise<BookmarkData | undefined>;
  ...
  const scrollFn = horizontalMouseWheel(4, document.documentElement, requestAnimationFrame)
...
<div
    ...
    ? `${firstDimensionMargin}px`
    : undefined}
    style:--font-family-serif={fontFamilyGroupOne.familyName}
    style:--font-family-sans-serif={fontFamilyGroupTwo.familyName}
