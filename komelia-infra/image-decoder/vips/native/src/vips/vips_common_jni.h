...
JNIEXPORT void komelia_throw_jvm_vips_exception_message(
    JNIEnv *env,
    const char *message
);
...
JNIEXPORT jobject komelia_to_jvm_image_data(
    JNIEnv *env,
    VipsImage *decoded
);

JNIEXPORT VipsImage *komelia_from_jvm_handle(
    JNIEnv *env,
    jobject jvm_image
);

JNIEXPORT jobject komelia_to_jvm_handle(
    JNIEnv *env,
    VipsImage *image,
