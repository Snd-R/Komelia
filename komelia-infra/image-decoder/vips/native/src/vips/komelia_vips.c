...
JNIEXPORT jobject JNICALL Java_snd_komelia_image_VipsImage_decode(
    JNIEnv *env,
    jobject this,
    jbyteArray encoded,
    jobject n_pages
    ...
    VipsImage *decoded;
    if (n_pages != nullptr) {
        decoded = vips_image_new_from_buffer(
            internal_buffer,
            input_len,
            "",
            "n",
            boxed_int_to_int(env, n_pages),
            nullptr
        );
    } else {
...
JNIEXPORT jobject JNICALL Java_snd_komelia_image_VipsImage_decodeFromFile(
    JNIEnv *env,
    jobject this,
    jstring path,
    jobject n_pages
    ...
    if (n_pages != nullptr) {
        decoded =
            vips_image_new_from_file(path_chars, "n", boxed_int_to_int(env, n_pages), nullptr);
    } else {
...
JNIEXPORT jobject JNICALL Java_snd_komelia_image_VipsImage_thumbnailBuffer(
    JNIEnv *env,
    jobject this,
    jbyteArray encoded,
    jint scaleWidth,
...
JNIEXPORT void JNICALL Java_snd_komelia_image_VipsImage_encodeToFile(
    JNIEnv *env,
    jobject this,
    jstring path
) {
...
JNIEXPORT void JNICALL Java_snd_komelia_image_VipsImage_encodeToFilePng(
    JNIEnv *env,
    jobject this,
    jstring path
) {
...
JNIEXPORT jobject JNICALL Java_snd_komelia_image_VipsImage_getDimensions(
    JNIEnv *env,
    jobject this,
    jbyteArray encoded
) {
    ...
    jobject jvm_dimensions = (*env)->NewObject(
        env,
        jvm_vips_class,
        constructor,
...
JNIEXPORT jbyteArray JNICALL Java_snd_komelia_image_VipsImage_getBytes(
    JNIEnv *env,
    jobject this
) {
    VipsImage *image = komelia_from_jvm_handle(env, this);
...
JNIEXPORT jobject JNICALL Java_snd_komelia_image_VipsImage_extractArea(
    JNIEnv *env,
    jobject this,
    jobject rect
) {
    ...
    int extract_error = vips_extract_area(
        input_image,
        &extracted_image,
        vips_rect.left,
        vips_rect.top,
...
JNIEXPORT jobject JNICALL Java_snd_komelia_image_VipsImage_shrink(
    JNIEnv *env,
    jobject this,
    jdouble factor
) {
...
jobject jvm_rect(
    ...
    return (*env)
        ->NewObject(env, jvm_vips_class, constructor, left, top, width + left, height + top);
}

JNIEXPORT jobject JNICALL Java_snd_komelia_image_VipsImage_findTrim(
    JNIEnv *env,
    jobject this
) {
    VipsImage *image = komelia_from_jvm_handle(env, this);
...
JNIEXPORT void JNICALL Java_snd_komelia_image_VipsImage_gObjectUnref(
    JNIEnv *env,
    jobject this,
    jlong ptr
) {
...
JNIEXPORT void JNICALL Java_snd_komelia_image_VipsImage_free(
    JNIEnv *env,
    jobject this,
    jlong bytes
) {
...
JNIEXPORT jobject JNICALL Java_snd_komelia_image_VipsImage_makeHistogram(
    JNIEnv *env,
    jobject this
) {
    VipsImage *image = komelia_from_jvm_handle(env, this);
...
JNIEXPORT jobject JNICALL Java_snd_komelia_image_VipsImage_mapLookupTable(
    JNIEnv *env,
    jobject this,
    jarray jvm_lut
) {
